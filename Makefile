...
OBJS = fmul_stage1.o fmul_stage2.o fmul_stage3.o fmul.o fmul_sim.o fadd_stage1.o fadd_stage2.o fadd_stage3.o fadd.o fadd_sim.o right_shift.o ZLC.o fsub.o fsub_sim.o fsub_stage1.o fmul_tb.o fmul_tb_sim.o fadd_tb.o fadd_tb_sim.o fsub_tb.o fsub_tb_sim.o floor.o floor_sim.o floor_tb.o floor_tb_sim.o ZLC_31.o i2f.o i2f_sim.o i2f_tb.o i2f_tb_sim.o finv.o finv_sim.o finv_tb.o finv_tb_sim.o feq.o feq_sim.o feq_tb.o feq_tb_sim.o flt.o flt_sim.o flt_tb.o flt_tb_sim.o fsqrt.o fsqrt_sim.o fsqrt_tb.o fsqrt_tb_sim.o
